...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::UncertaintyComputer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("UncertaintyComputer", ::UncertaintyComputer::Class_Version(), "interface/UncertaintyComputer.hh", 28,
...
"/home/rverma/t3store3/Ether/CMSSW_10_4_0/src/EtherAnalysis/src/..",
"/cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-ikaegh3/include",
"/grid_mnt/t3storage3/rverma/Ether/CMSSW_10_4_0/src/EtherAnalysis/src/",
0
    };
